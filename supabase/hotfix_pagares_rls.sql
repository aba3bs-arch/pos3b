-- HOTFIX RLS pagares (si solo falla el INSERT).
-- Preferible: ejecuta supabase/fix_pagares.sql completo (tabla + columnas + RLS).
-- Este archivo no pide contraseña ni parámetros: pegar en SQL Editor → Run.
