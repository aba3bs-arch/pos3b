...
export const UBICACION_SUCURSALES = {
  ...
  '3B3': { nombre: 'Petróleos', lat: 31.300544, lon: -110.936193 },
  ...
  '3B9': { nombre: 'Buenos Aires', lat: 31.329842, lon: -110.943361 },
  '3B10': { nombre: 'El Mezquite', lat: 31.301250, lon: -110.937966 },
};
