...
export const TUTORIALES = [
  ...
  {
    id: 'cobros-caja',
    titulo: 'Cobros en caja: efectivo, dólares y tarjeta',
    resumen:
      'Cómo armar el ticket y cobrar en pesos, dólares o tarjeta (con los últimos 4 o 5 dígitos del ticket de la terminal). Capturas reales de la app.',
    secciones: [
      {
        id: 'ticket',
        titulo: '1. Armar el ticket y cobrar',
        cuerpo: [
          '1. Menú → **Ventas** (revisa la tienda arriba).',
          '2. Escanea o busca en **Código o nombre…** / Favoritos.',
          '3. Revisa el **Ticket** y el **TOTAL $… MXN**.',
          '4. Pulsa el botón verde **Cobrar**.',
          '5. Se abre **Cobrar venta**.',
        ],
        imagen: '/tutorial-cobros/cobro-01-ticket-cobrar.png',
        imagenAlt: 'Pantalla Ventas con ticket y botón Cobrar',
      },
      {
        id: 'efectivo-mxn',
        ...
        cuerpo: [
          ...
          '2. Moneda → **Pesos (MXN)**.',
          '3. **Monto exacto · $… MXN** o billete ($20…$1000).',
          '4. Revisa **Cambio: $… MXN**.',
          '5. **Finalizar venta**.',
        ],
        imagen: '/tutorial-cobros/cobro-02-efectivo-pesos.png',
        imagenAlt: 'Cobrar venta — Efectivo MXN',
      },
      {
        id: 'efectivo-usd',
        ...
        cuerpo: [
          ...
          '3. El **cambio siempre es en MXN** (tipo de cambio del encabezado).',
          '4. **Finalizar venta**.',
        ],
        imagen: '/tutorial-cobros/cobro-03-efectivo-dolares.png',
        imagenAlt: 'Cobrar venta — Efectivo USD',
      },
      {
        id: 'tarjeta',
        titulo: '4. Pago con tarjeta',
        cuerpo: [
          '1. **Forma de pago** → **Tarjeta**.',
          '2. **Cobra primero en la terminal física**.',
          '3. Anota los **últimos 4 o 5 dígitos** del ticket de la terminal en **Referencia / folio**.',
          '4. En el POS pulsa **Finalizar venta**.',
        ],
        imagen: '/tutorial-cobros/cobro-04-tarjeta.png',
        imagenAlt: 'Cobrar venta — Tarjeta con referencia de dígitos',
        notas: [
          '**Obligatorio en práctica:** los últimos **4 o 5 dígitos** del ticket de la terminal van en la referencia.',
      ...
      },
      {
        ...
        cuerpo: [
          'Aparece **Venta registrada** con cobro y cambio.',
          '**Cerrar** para seguir vendiendo, o **Imprimir ticket**.',
        ],
      ...
      },
      {
        ...
        cuerpo: [
          ...
          '· **Tarjeta:** finalizar sin cobrar en la terminal.',
          '· **Tarjeta:** olvidar anotar los **últimos 4 o 5 dígitos** del ticket.',
      ...
      },
      {
        ...
        titulo: 'Frase para capacitar',
        cuerpo: [
          'Ticket → **Cobrar** → **Efectivo** (MXN/USD) o **Tarjeta** → **Finalizar venta**.',
          'En tarjeta: terminal primero + **últimos 4 o 5 dígitos** en la referencia.',
        ],
      },
    ],
  },
  {
    id: 'corte-caja',
    titulo: 'Corte de caja (ventas del punto de venta)',
    resumen:
      'Cómo cerrar el turno de ventas de mostrador: resumen, arqueo de efectivo, corroborar tarjeta y Guardar corte. Capturas reales de la app.',
    secciones: [
      {
        id: 'abrir-corte',
        titulo: '1. Abrir Corte de caja',
        cuerpo: [
          '1. Menú → **Corte de caja** (el de ventas de producto, no Corte Virtual).',
          '2. Confirma **tienda**, **fecha** y **turno** (diurno / nocturno).',
          '3. Pestaña **Corte**.',
        ],
        imagen: '/tutorial-corte-caja/corte-01-pantalla.png',
        imagenAlt: 'Pantalla Corte de caja con resumen, arqueo y corroboración',
        notas: [
          'No confundir con **Corte Virtual / Abarrotes / Garage** (caja chica de área). Aquí es el corte de **Ventas** del mostrador.',
        ],
      },
      {
        id: 'resumen-arqueo',
        titulo: '2. Resumen y arqueo de efectivo',
        cuerpo: [
          'Revisa el **Resumen del turno** (total, tickets, efectivo / tarjeta / otros).',
          'En **Arqueo de efectivo**:',
          '1. Cuenta el efectivo real de la caja.',
          '2. Escríbelo en **Efectivo contado (MXN)**.',
          '3. Revisa la **Diferencia** (contado − esperado). Ideal: $0.00.',
        ],
        imagen: '/tutorial-corte-caja/corte-01-pantalla.png',
        imagenAlt: 'Arqueo de efectivo en Corte de caja',
      },
      {
        id: 'corroborar',
        titulo: '3. Corroborar tarjeta y otros',
        cuerpo: [
          'En **Corroboración otros rubros** compara lo del sistema con la terminal / banco / app:',
          '· **Tarjeta**',
          '· **Transferencia**',
          '· **QR / digital**',
          'Captura el **Contado** de cada rubro y revisa la diferencia.',
        ],
        imagen: '/tutorial-corte-caja/corte-01-pantalla.png',
        imagenAlt: 'Corroboración de tarjeta y otros rubros',
      },
      {
        id: 'guardar-corte',
        titulo: '4. Guardar e imprimir',
        cuerpo: [
          'Cuando todo cuadre, pulsa **Guardar corte**.',
          'Puedes **Imprimir preview** o **Imprimir corte** para el expediente.',
          'Pestañas **Movimientos** y **Cancelaciones** sirven para revisar tickets del turno.',
        ],
      },
      {
        id: 'frase-corte',
        titulo: 'Frase para capacitar',
        cuerpo: [
          '**Corte de caja** = cierre de las **ventas** del turno.',
