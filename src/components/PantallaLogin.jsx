        ...
        {!tiendaFijadaParaAcceso && !sucursalFijaEnv && (
          <>
            ...
            <p className="muted login-hint">
              ...
              (o un 2.º con autorización de administrador). <strong>MAIN</strong> (central admin) no se fija.
              <strong> CEDIS</strong> sí se puede fijar (PC de almacén). El administrador no se ancla a dispositivo.
            </p>
          </>
        )}
