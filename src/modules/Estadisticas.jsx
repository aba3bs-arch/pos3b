...
const DESCRIPCIONES = {
  'Estadísticas Abarrotes': {
    ...
    ayuda: 'Ventas de corte Abarrotes (incluye pago con tarjeta), tráfico de clientes (tickets POS por tienda/hora), gastos, inventario y mermas en todas las sucursales.',
  },
