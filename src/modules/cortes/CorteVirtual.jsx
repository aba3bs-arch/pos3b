        ...
        <div style={{ display: 'flex', flexWrap: 'wrap', gap: '0.75rem', alignItems: 'flex-start', justifyContent: 'space-between' }}>
          <div>
            ...
            <p className="muted" style={{ margin: '0.25rem 0 0', fontSize: '0.72rem' }}>
              {estado._post_recoleccion
                ? 'Tras recolección: al cambiar el tope se actualiza la MI (inyección = tope − base)'
                : 'Referencia · tras cierre la MI = MF anterior · tras recolección se inyecta tope − MF'}
            </p>
            {miInyectada && (
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(300px, 1fr))', gap: '1rem', alignItems: 'start' }}>
        <div className="card">
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
            ...
            <CampoCorte
              ...
              hint={
                estado._post_recoleccion
                  ? 'Tras recolección = tope (con inyección). También cambia si editas el tope.'
                  : puedeInyectarMi
                    ? 'Tras cierre = MF anterior · solo admin inyecta aquí'
        ...
        <div className="card">
          ...
          <CorteGastosPanel
            ...
            notaNomina="Gastos sin aprobación. CUBRE TURNO → IE Virtual (nómina). Consumo/recargas/anticipos/faltante descuentan al empleado. Vales y préstamos requieren admin."
          />
        </div>
      </div>
