...
} from '../lib/inventarioMovimientos.js';
...
async function aplicarInventarioCompra(supabase, items, motivoBase, { sucursal, user, folio }) {
  ...
  const folioCompra =
    ...
    (await siguienteFolioMovimiento(supabase, 'entrada', sucursal));
...
export default function Compras({ supabase, sucursal, inventario, cargarDatos, onNavigate, user }) {
  ...
  const registrarEntregaDirecta = async () => {
    ...
    const folioCompra = await siguienteFolioMovimiento(supabase, 'entrada', sucursal);
