              ...
              <>
                ...
                >
                  ...
                  <p className="muted" style={{ margin: '0 0 0.65rem', fontSize: '0.82rem' }}>
                    Los submódulos <strong>Nómina</strong>, <strong>Panel RT</strong>, <strong>Liquidación recolecciones</strong> y <strong>IE VIRTUAL</strong> aparecen al abrir Contabilidad. Los subcomandos del Panel RT se asignan en Acciones especiales abajo.
                  </p>
