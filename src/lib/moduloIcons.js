...
export const ICONO_MODULO = {
  ...
  Consolidación: 'chart',
  'Compras vs inventario': 'package',
  'Revisión de compras': 'search',
  'Registro de gastos': 'file',
  'Socio 3B': 'building',
  Productos: 'package',
  'Venta en Ruta': 'truck',
  Compras: 'truck',
...
export const COLOR_MODULO = {
  ...
  Conciliaciones: '#b5a642',
  Consolidación: '#0f766e',
  'Compras vs inventario': '#0369a1',
  'Revisión de compras': '#0e7490',
  'Registro de gastos': '#0d9488',
  'Socio 3B': '#1d4ed8',
  Productos: '#8b5cf6',
