...
/** Asignar / quitar / mover / fijar descansos (privilegio aparte del solo ver el plan). */
...
export const ACCIONES_CHECADOR_PRIVILEGIO = [
  ...
  },
  {
    ...
    desc: 'Fijar, mover o quitar descansos (candado, esta semana o habitual). Solo administrador o quien tenga este privilegio.',
  },
];
...
/**
 * ¿Puede marcar / quitar / fijar / mover descansos en Plan horario?
